...
function Footer() {
  return (
    <div>
      <div className="flex w-[1312px] h-[345px] m-auto justify-between mt-[35px]">
        <div className="w-[618px] h-[305px]">
            <h2 className="text-Manrope text-[48px] ">Ready to get started?</h2>
            <p className="w-[554px] text-[18px] text-Manrope mt-[30px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ut consequat eros. Sed ut convallis tellus, at semper nulla. Pellentesque tellus odio, fringilla sed mi vel, maximus gravida diam.</p>
        ...
        <div className="w-[505px] h-[282.88] mt-[30px]">
            <div>
                <h2 className="text-[24px] text-[Monrope]">Links</h2>
                <div className="flex w-[430px] justify-between text-Monrope text-[16px] text-[#8A8A8A]">
                    <p>Home</p>
                    <p>About Us</p>
                    <p>Company</p>
                    <p>Support</p>
            ...
            <div className="mt-[35px]">
                ...
                <div className="flex w-[300px] justify-between text-Monrope text-[16px] text-[#8A8A8A]">
                    <p>Native APIs</p>
                    <p>Chat Bot</p>
                    <p>CRMs</p>
                    <p>POs</p>
      ...
      <hr className="border border-[#545454] w-[90%] m-auto"></hr>
      <div className="h-[129px] w-[1212px] m-auto px-[20px] flex justify-between items-center text-[#A8A8A8]">
